...
namespace Stucco.NSwag.Core
{
    ...
    public enum SwaggerParameterCollectionFormat
    {
        ...
        [EnumMember(Value = "ssv")] Ssv,

        /// <summary>Tab separated values "foo\tbar".</summary>
        [EnumMember(Value = "tsv")] Tsv,

        /// <summary>Pipe separated values "foo|bar".</summary>
        [EnumMember(Value = "pipes")] Pipes,

        /// <summary>
        ///     Corresponds to multiple parameter instances instead of multiple values for a single instance "foo=bar&amp;
        ///     foo=baz".
        /// </summary>
